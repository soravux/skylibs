...
def sunPosFromCoord(latitude, longitude, time, elevation=0):
    """
    ...
    azim = solar.get_azimuth(latitude, longitude, time, elevation)
    alti = solar.get_altitude(latitude, longitude, time, elevation)
